...
| `plan/` | `KeepPolicy` (protected > preferred > not a copy name > name not generated by a device/app > folder not generic > oldest > shortest path > alphabetical; the decisive criterion is recorded as `KeepReason`) and `build_plan`. |
